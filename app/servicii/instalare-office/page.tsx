...
import { Clock, CheckCircle2, Monitor, Rocket, ChevronLeft, ChevronRight, FileText } from 'lucide-react';
...
const images = [
  ...
  "https://picsum.photos/seed/office2/800/800",
  "https://picsum.photos/seed/office3/800/800"
];
      ...
      <div className="pt-32 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Instalare Suita Office</h1>
            ...
            <div className="space-y-6 text-gray-300 text-sm leading-relaxed">
              <p className="font-medium text-white text-base">🔥 Vrei să ai aplicațiile Microsoft Office pe PC-ul tău, dar nu știi de unde să începi? 🔥</p>
              
              <p>Nu-ți face griji! Noi ne ocupăm de tot și îți instalăm Suita Office rapid și simplu, pentru ca tu să te poți apuca de treabă fără probleme.</p>
              
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex gap-3 text-emerald-400 text-sm leading-relaxed">
                <CheckCircle2 className="w-5 h-5 shrink-0 mt-0.5" />
                <p><strong>Activare Inclusă:</strong> Suita Office va fi complet activată și gata de utilizare imediat după instalare.</p>
              </div>

              <div>
                <h2 className="flex items-center gap-2 mb-3 font-bold text-lg text-white">
                  <FileText className="w-5 h-5 text-emerald-400" />
                  Ce conține Suita Office:
                </h2>
                <ul className="list-none space-y-3 text-gray-400">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft Word</strong> – pentru documentele tale</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft Excel</strong> – pentru tabele, calcule și analize</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft PowerPoint</strong> – pentru prezentări de impact</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft Access</strong> – pentru gestionarea bazelor de date</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft Outlook</strong> – pentru o comunicare rapidă și eficientă</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Microsoft Publisher / Frontpage</strong> – pentru crearea de materiale și site-uri</span>
                  </li>
                </ul>
              </div>
