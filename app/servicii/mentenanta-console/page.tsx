...
import { Clock, Gamepad2, CheckCircle2, Rocket, Package, ChevronLeft, ChevronRight } from 'lucide-react';
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';
import FloatingActions from '@/components/FloatingActions';

const images = [
  "https://lh3.googleusercontent.com/d/1j6vX-hr5vbhmV_kF9RSaJYoxFSR4jwh_",
  "https://lh3.googleusercontent.com/d/1E7TShkrVI2zYnnHxoWkRp1i0IUoLeGmd",
  "https://lh3.googleusercontent.com/d/1-subTa2AhKdXl_N57X8czv1J_qS1E0ar",
  "https://lh3.googleusercontent.com/d/1rBKIir_m0NsKJTzTVMB2VP_oBfLijfyN",
  "https://lh3.googleusercontent.com/d/1bXIR_6QUJmAd_crOqAYKY4ojCixIHO1I",
  "https://lh3.googleusercontent.com/d/1EhVa4aueY08T2xHGWG-R6HaA9oEW3zO2"
];
      ...
      <div className="pt-40 lg:pt-48 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Mentenanță Console</h1>
            ...
            <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6 mb-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                ...
                <div className="text-4xl font-bold text-emerald-400">199,99 lei</div>
              </div>
            ...
            <div className="space-y-6 text-gray-300 text-sm leading-relaxed">
              <p className="font-medium text-white text-base">🔥 Consola ta are probleme? 🔥</p>
              
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center gap-2">• Se încălzește prea tare sau se stinge random?</li>
                <li className="flex items-center gap-2">• Jocurile nu mai merg cum trebuie, se blochează sau sacadează?</li>
                <li className="flex items-center gap-2">• Zgomotul ventilatorului e insuportabil? &quot;Face ca avionul?&quot;</li>
              </ul>
              
              <p className="text-base text-white font-medium bg-white/5 p-4 rounded-xl border border-white/10">
                Dacă te confrunți cu aceste probleme, consola ta are nevoie de revizie cat mai profi!
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="list-none space-y-3 text-gray-400">
                    <li className="flex items-start gap-3">
                      ...
                      <span>XBOX (One - Normal, S, X / Series - S, X)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>PlayStation (PS4 - Normal, Slim, Pro / PS5)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>Nintendo și alte console portabile</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-none space-y-3 text-gray-400">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>Curățare completă (carcasă, ventilator, placă de bază, radiator etc.)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>Schimbare pastă termoconductoare</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>La PS5 se schimbă metalul lichid de pe APU</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>Înlocuire thermal pad-uri / putty de pe memorii și celelalte cipuri (unde e necesar)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                      <span>Verificarea vieții HDD / SSD-ului (dacă e posibil)</span>
                    </li>
                  </ul>
                </div>
              </div>
